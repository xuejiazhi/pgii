...
var (
	ShowPrettyHeader = map[string]map[string][]interface{}{
		"cn": {
			...
			Database15ShowHeader: []interface{}{"#oid", "数据库", "数据库拥用者", "字符编码", "LC_COLLATE", "LC_CTYPE", "允许连接", "最大并发连接数", "表空间", "数据库尺寸"},
		...
		"en": {
			...
			Database15ShowHeader: []interface{}{"#oid", "DbName", "Auth", "Encoding", "LC_COLLATE", "LC_CTYPE", "AllowConn", "ConnLimit", "TableSpace", "size"},
	...
	Database15ShowHeader = "Database15ShowHeader"
